        ...
        <div class="search-item" :key="index" v-for="(col, index) in searchCols">
            ...
            >
                ...
                <a-switch
                    ...
                    size="small"
                    :checked-children="
                        (col.search.switchOptions && col.search.switchOptions.checkedText) || '是'
                    "
                    :un-checked-children="
                        (col.search.switchOptions && col.search.switchOptions.uncheckedText) || '否'
                    "
                />
                <a-icon
            ...
            <div v-else :class="['title', { active: col.search.value }]">
                ...
                >
                    ...
                    <div class="operations" slot="content">
                        <a-button @click="onCancel(col)" class="btn" size="small" type="link"
                            >取消</a-button
                        >
                        <a-button @click="onConfirm(col)" class="btn" size="small" type="primary"
                            >确认</a-button
                        >
                    </div>
